    ...
    <AuthShell>
      ...
      {checkingLink ? (
        ...
        >
          ...
          <div className="flex flex-col gap-2.5 mt-5">
            ...
            <Link
              ...
              className="w-full inline-flex items-center justify-center py-3 text-sm font-semibold rounded-xl text-white/75 hover:text-white transition-colors"
        ...
        <div className="space-y-3">
          ...
          <Link
            href="/login"
            className="flex items-center justify-center w-full py-3 text-sm font-semibold rounded-xl text-white/80 transition-colors"
