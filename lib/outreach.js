...
export function buildWinnerNotificationHtml({ prizeLabel, note, surveyUrl = WINNER_SURVEY_URL } = {}) {
  ...
  const paragraphs = [
    ...
    `<a href="${escapeHtml(surveyUrl)}" style="display:inline-block;padding:12px 18px;border-radius:10px;background:#FFCB05;color:#0b1a3b;font-weight:700;text-decoration:none;">Complete Payment Survey</a>`,
