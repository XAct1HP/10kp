...
export const STEPS = [
  ...
  { id: "pitch",   label: "Pitch",   title: "Shape your 60 seconds",     blurb: "Turn what you've built into the beats of a one-minute pitch, then take it and record." },
];
...
export const PITCH_BEATS = [
  { id: "hook",     label: "Hook",           seconds: 5,  prompt: "One line that makes someone lean in: a surprising fact, a question, or a moment everyone recognizes." },
  { id: "problem",  label: "Problem",        seconds: 15, prompt: "The real problem you dug up, in plain words." },
  { id: "who",      label: "Who has it",     seconds: 10, prompt: "The person you pictured, and what they put up with today." },
  { id: "solution", label: "Your solution",  seconds: 20, prompt: "What you'd do, and why it beats the workaround." },
  { id: "why",      label: "Why now / why you", seconds: 10, prompt: "What makes this the right moment, or you the right person to do it?" },
];
