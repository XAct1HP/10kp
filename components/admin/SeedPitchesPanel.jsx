            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  aria-label="Remove seed pitch"
                  title="Remove"
                  className="w-7 h-7 flex-shrink-0 rounded-md flex items-center justify-center text-red-300 hover:text-red-200 transition-colors disabled:opacity-40"
                  style={{
